import './App.css';
import { news, stocks, search, banner, weather, broadcast, mostVisited } from './Data/Data';
  ...
  return (
    <div className="App">
      ...
      <div className="row row-block bottom-row">
        <Block className="weather-widget" title="Погода в Кемерово">
          <Weather weather={weather} />
        </Block>
        <Block className="schuddle" title="Карта">
          <div>Расписание автобусов города Кемерово</div>
        </Block>
